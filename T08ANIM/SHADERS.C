 ...
 */
static CHAR * VK3_RndShaderLoadTextFile( CHAR *FileName )
{
  FILE *F;
  CHAR *text;
  INT flen;
 ...
 */
UINT VK3_RndShaderLoad( CHAR *FileNamePrefix )
{
  INT i, res;
  CHAR *txt;
  CHAR *suff[] = {"VERT", "FRAG"};
  ...
  for (i = 0; isok && i < NS; i++)
  {
    ...
    {
      VK3_RndShaderLog(suff[i], "Error create shader");
      isok = FALSE;
      break;
    }
    /* Load text file */
